  ...
  return (
    <article className="relative bg-white">
      ...
      <div className="relative h-[75vh] min-h-[600px] w-full overflow-hidden bg-slate-950">
        ...
        <div className="absolute bottom-0 left-0 right-0 mx-auto max-w-[1440px] px-8 pb-24 z-20">
      ...
      <div className="relative z-30 mx-auto max-w-[1440px] px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          <main className="lg:col-span-8 py-24">
          ...
          <aside className="hidden lg:block lg:col-span-4 pt-24">
            <div className="sticky top-32 space-y-12">
              ...
              <div className="rounded-[40px] bg-slate-900 p-10 text-white shadow-2xl">
                ...
                <button className="mt-8 w-full rounded-2xl bg-white py-5 text-black font-black hover:bg-primary transition-colors">
                  WhatsApp Support
                </button>
              </div>
            </div>
