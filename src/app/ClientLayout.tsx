    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 md:px-6 flex items-center justify-between">
          {/* LOGO */}
          <Link href="/" className="relative block h-10 w-48 shrink-0">
             <Image
               src="/images/sri-lanka-private-airport-transfer-driver-logo.webp"
               alt="Sri Lanka Transfers"
               fill
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
          <Link
            href="/"
            className="relative block h-8 w-40"
